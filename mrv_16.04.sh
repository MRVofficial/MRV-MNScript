#!/bin/bash
# MRVCoin Masternode Setup Script V1.0 for Ubuntu 16.04 LTS
#
...
wget https://github.com/MRVofficial/MRVCoin/releases/download/v1.0/mrvcoin-1.0.0.0-daemon_ubuntu16.04.tar.gz
tar -xzvf mrvcoin-1.0.0.0-daemon_ubuntu16.04.tar.gz
